...
#include <tabletop_perception/extern/graphcut/graph.h>
...
class ArmObjSegmentation
{
 ...
 protected:
  ...
  static cv::Mat convertFlowToMat(tabletop_perception::GraphType *g, tabletop_perception::NodeTable& nt, int R, int C);
